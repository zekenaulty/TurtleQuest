...
Write-Host "  dotnet run --project $root/bridge/TurtleQuest.Bridge"
Write-Host "Bridge URL:"
Write-Host "  http://127.0.0.1:57421"
Write-Host ""
Write-Host "Optional Agentica planner adapter env:"
Write-Host "  `$env:TURTLEQUEST_AGENTICA_PLANNER_COMMAND = '<command>'"
Write-Host "  `$env:TURTLEQUEST_AGENTICA_PLANNER_ARGS = '<args>'"
...
Write-Host "  $root/mod/turtlequest-neoforge"
